...
//         let headerImg = () => {
//             if (width < 1187) {
//                 return imgHeaderPhoto.src = 'img/content-img-header2.png'
//                 // headerPhoto.innerHTML = `
//                 //     <img class="section-header-wrapper__photo__img" src="img/content-img-header2.png" alt="Photo">
//                 // `
                
//                 console.log('ss')
//             } else {
//                 return imgHeaderPhoto.src = 'img/content-img-header.png'
//                 // headerPhoto.innerHTML = `
//                 //     <img class="section-header-wrapper__photo__img" src="img/content-img-header.png" alt="Photo">
//                 // `
